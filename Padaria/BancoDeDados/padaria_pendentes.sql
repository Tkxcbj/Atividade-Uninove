...
CREATE TABLE `pendentes` (
  ...
  `senha` varchar(30) COLLATE utf8_czech_ci NOT NULL,
  `cargo` varchar(10) COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`usuario`)
...
INSERT INTO `pendentes` VALUES ('admin','admin','Selecione'),('carla','abc','caixa');
